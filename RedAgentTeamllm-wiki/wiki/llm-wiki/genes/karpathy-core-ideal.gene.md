...
- llm
- auto-generated
title: Karpathy Core Ideal.Gene
type: article
version: '1.0'
...
---
# Gene: Karpathy Core Ideal

**gene_id**: `GENE_001_KARPATHY_CORE_IDEAL`  
**type**: Gene  
**version**: 1.0.0  
...
Karpathy 提出的 AOT (Ahead-Of-Time) 編譯模式要求:
...
`Karpathy`, `AOT`, `JIT_RAG`, `knowledge_compilation`, `persistent_wiki`, `LLM_maintained`, `compounding_knowledge`, `markdown_git`, `EvoMap_Gene`, `architecture`
