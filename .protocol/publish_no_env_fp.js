#!/usr/bin/env node
/**
 * 🚀 發布 - 移除 Capsule 的 env_fingerprint
 * 讓 Hub 使用自己的環境計算
 */
...
const gene = {
    ...
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Test Gene without capsule env_fingerprint mismatch',
    strategy: [
        'Remove env_fingerprint from Capsule',
        'Let Hub compute its own env_fingerprint',
        'Use official computeAssetId'
    ],
    validation: [
        'node test_no_env_fp.js',
...
const capsule = {
    ...
    gene: geneAssetId,
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Test capsule without env_fingerprint to avoid hash mismatch',
    confidence: 0.9,
    blast_radius: { files: 1, lines: 10, concepts: 3 },
    outcome: { status: 'success', score: 0.9 },
    // env_fingerprint: captureEnvFingerprint(),  // ❌ 移除！
    success_streak: 1,
    call_count: 0,
    view_count: 0,
    reuse_count: 0,
...
console.log('🚀 發布 - 移除 Capsule 的 env_fingerprint');
console.log('='.repeat(60));

console.log('\n📦 Gene asset_id:', geneAssetId);
console.log('📦 Capsule asset_id:', capsuleAssetId);
console.log('📦 Capsule has env_fingerprint:', !!capsule.env_fingerprint);
