...
const gene = {
    ...
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Validate endpoint test with correct validation commands',
    strategy: [
...
const capsule = {
    ...
    gene: geneAssetId,
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Capsule for validate endpoint with correct validation commands',
    confidence: 0.95,
...
console.log('🚀 Validate 接口 - 修復 validation 命令');
console.log('='.repeat(60));
