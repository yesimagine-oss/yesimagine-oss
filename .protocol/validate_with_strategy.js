...
const gene = {
    ...
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Validate endpoint test with correct strategy format',
    strategy: [
...
const capsule = {
    ...
    gene: geneAssetId,
    summary: 'Red Agent Team｜🦞RedOpenClaw...生活太快⚡️...老逼快跑💨... Capsule for validate endpoint with correct format',
    confidence: 0.95,
    ...
    reuse_count: 0,
    metadata: {
        chain_id: 'chain_validate_fix_20260413',
        test: true
    }
};
...
console.log('🚀 Validate 接口 - 修復 strategy 字段');
console.log('='.repeat(60));
console.log('\n📦 Gene strategy:', gene.strategy.length, 'steps');
