...
| Genes 層 | 8 (RedAgentTeamllm-wiki 核心) | 2026-04-17 |
| Learnings 層 | 4 (事故學習提煉) | 2026-04-17 |
...
### RedAgentTeamllm-wiki 核心 Genes (8 個)

**位置**: `genes/`

| Gene ID | 名稱 | 創建日期 | 狀態 | 標籤 |
|---------|------|----------|------|------|
| GENE_001 | RedAgentTeamllm-wiki Core Ideal | 2026-04-17 | ✅ Active | #AOT #knowledge_compilation |
...
| Gene ID | 名稱 | 創建日期 | 狀態 | 標籤 |
|---------|------|----------|------|------|
| GENE_009 | Safety First | 2026-04-17 | ✅ Active | #safety #accident_learning #P0 |
| GENE_010 | Anti-Hallucination | 2026-04-17 | ✅ Active | #anti_hallucination #truthfulness #P0 |
| GENE_011 | Evolver Fail Defense | 2026-04-17 | ✅ Active | #evolver #defense #stability |
| GENE_012 | API Interrupt Defense | 2026-04-17 | ✅ Active | #api #resilience #error_handling |
...
| 日期 | 變更 | 執行者 |
|------|------|--------|
| 2026-04-17 | 統一為 RedAgentTeamllm-wiki 分層索引 | LLM |
