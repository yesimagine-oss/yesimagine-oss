...
# -*- coding: utf-8 -*-
"""
发布抖音带货选品策略 - 修复 schema_version 为 1.6.0
Evolver 源码显示 SCHEMA_VERSION = '1.6.0'
"""
...
def canonicalize(obj):
    """与 Evolver 一致的 canonical JSON"""
    if obj is None or obj is None:
        return 'null'
    if isinstance(obj, bool):
        return 'true' if obj else 'false'
    if isinstance(obj, (int, float)):
        if not (obj == obj and abs(obj) != float('inf')):  # NaN or Inf check
            return 'null'
        return str(obj)
...
print("="*60)
print("🚀 发布抖音带货选品策略 (schema_version 1.6.0)")
print("="*60)

# 准备 Gene - schema_version 1.6.0
gene = {
    "type": "Gene",
    "schema_version": "1.6.0",  # 修复！
    "category": "optimize",
...
# 准备 Capsule - schema_version 1.6.0，必须有 trigger 和 gene 字段
capsule = {
    "type": "Capsule",
    "schema_version": "1.6.0",  # 修复！
