...
# -*- coding: utf-8 -*-
"""
发布抖音带货选品策略 - 使用 /a2a/validate 先验证
文档说：Always use POST /a2a/validate first to verify your asset_id hashes before publishing.
"""
...
print("="*60)
print("🔍 使用 /a2a/validate 验证 asset_id")
print("="*60)
...
try:
    ...
    if validate_resp.status_code == 200:
        ...
        if 'correction' in validate_result:
            print(f"建议：{validate_result['correction'].get('fix')}")
